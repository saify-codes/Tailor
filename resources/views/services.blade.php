            ...
            <div class="row row-cols-md-2 row-cols-lg-4 row-cols-sm-1">
                <div class="col">
                    <div class="card-make shadow-none">
                        <div>
                            <img class="img-fluid w-100" style="border-radius: 15px" src="img/srevices/product 1.webp" />
                        </div>
                ...
                <div class="col">
                    <div class="card-make shadow-none">
                        <div>
                            <img class="img-fluid w-100" style="border-radius: 15px" src="img/srevices/product 2.webp" />
                        </div>
                ...
                <div class="col">
                    <div class="card-make shadow-none">
                        <div>
                            <img class="img-fluid w-100" style="border-radius: 15px" src="img/srevices/product 4.webp" />
                        </div>
