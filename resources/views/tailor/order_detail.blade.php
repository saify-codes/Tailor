    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            ...
            <div class="mb-5">
                ...
                <h2 class="font-semibold text-gray-700">Address: <span class="text-gray-400">{{ $order->address }}</span>
                </h2>
                <h2 class="font-semibold text-gray-700">Price: <span class="text-gray-400">{{ $order->price }}</span>
                </h2>
            </div>
            <!-- New Table -->
